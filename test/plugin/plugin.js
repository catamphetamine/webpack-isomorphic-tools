...
describe('plugin', function () {
    ...
    it('should work with v4', function (done) {
    ...
    it('should check if name is present', function (done) {
        // aliasing node_modules
        const aliases = {'original_module_name': 'aliased_module_name'}
    ...
    it('should type check if name is string', function (done) {

        const plugin_settings = extend({}, settings())
        ...
        plugin_settings.debug = true
        plugin_settings.name = true
        const try_plugin = (plugin_settings, webpack_configuration) => {
            return () => new plugin(plugin_settings).apply
            ({
                options: webpack_configuration,
            })
        }

        try_plugin(plugin_settings, webpack_configuration).should.throw('"name" configuration parameter must be an string')
